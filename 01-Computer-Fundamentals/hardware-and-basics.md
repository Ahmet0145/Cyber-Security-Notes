...
## 📌 Table of Contents
A. [Overview & System Architecture](#overview--system-architecture)
...
C. [Boot Process (What Happens When You Press Start?)](#boot-process-what-happens-when-you-press-start)
